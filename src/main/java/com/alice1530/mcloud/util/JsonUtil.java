...
public class JsonUtil {
    ...
    public static <T> T readValue(String json, TypeReference<T> valueTypeRef) throws Exception {
        try {
    ...
    public static Object getJsonNodeValue(String json, String path) throws Exception {
        try {
    ...
    private static JsonNode getJsonNode(String responseBody) throws Exception {
        try {
